...
def get_all_impersonations_padrino(filters: dict | None = None):
...
def get_impersonations_padrino_by_id(id: int):
...
def update_impersonations_padrino(id: int, payload: dict):
