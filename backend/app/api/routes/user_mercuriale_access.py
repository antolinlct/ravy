...
def list_user_mercuriale_access(order_by: str | None = None, direction: str | None = None):
    filters = {"order_by": order_by, "direction": direction}
    filters = {k: v for k, v in filters.items() if v is not None}
    return user_mercuriale_access_service.get_all_user_mercuriale_access(filters)
